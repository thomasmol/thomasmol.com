...
<main class="">
	<section id="hero" class="max-h-screen overflow-hidden bg-stone-900 backdrop-blur-0">
		...
		<div class="container space-y-4 pt-10  md:pt-20">
			<img
				src="/images/about.webp"
				alt="Thomas Mol"
				width="4rem"
				height="4rem"
				class="h-auto w-24 bg-stone-200 shadow-xl shadow-stone-800 first:rounded-full" />
			<h1 class="text-3xl font-bold text-stone-100">Thomas Mol</h1>
			<h2 class="text-xl font-bold text-stone-200">Web en app developer uit Utrecht</h2>
		...
		<div class="container">
			...
			<div class="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-20 lg:gap-40">
				<div>
					...
					<h2 class="mt-4 text-xl font-semibold text-stone-800 dark:text-stone-100">Websites</h2>
				...
				<div>
					...
					<h2 class="mt-4 text-xl font-semibold text-stone-800 dark:text-stone-100">Apps</h2>
